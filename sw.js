const CACHE_NAME = 'together-eat-shell-v100';
const APP_SHELL = [
  './', 
  './index.html', 
  './osm-adapter.js?v=5',
  ...
  './src/providers/providerRegistry.js?v=52',
  ...
  './src/providers/taiwanOpenDataAdapter.js?v=52',
  './src/providers/nlscAdapter.js?v=52',
  './src/providers/hotPepperAdapter.js?v=52',
  './src/providers/kakaoLocalAdapter.js?v=52',
  './src/providers/naverLocalAdapter.js?v=52',
  './src/providers/naverBlogAdapter.js?v=52',
  './src/providers/yelpAdapter.js?v=52',
  './src/services/countryProviderRouter.js?v=52',
  './src/services/placeIdentityResolver.js?v=52',
  './src/services/reviewResolver.js?v=52',
  './src/services/discoveryResolver.js?v=52',
  './src/services/enrichment.js?v=2',
  './src/services/communityData.js?v=3',
  './src/services/personalization.js?v=1',
  './src/services/placeIntelligence.js?v=52',
